...
sepalValue = st.sidebar.slider('sepal length',min_value=0.0,max_value=10.0,step=0.1)
petalValue = st.sidebar.slider('petal length',min_value=0.0,max_value=10.0,step=0.1)
